...
const RatingCardSvg = ({ rating, progressValue }) => {
	return(
		<svg width="60" height="100" viewBox="0 0 91 93" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<text fill="white" xmlSpace="preserve" style={{"white-space": "pre"}} fontFamily="Roboto" fontSize="25" fontWeight="bold" letterSpacing="0em"><tspan x="30.1445" y="54.0449">{rating}</tspan></text>
		</svg>
	);
}
